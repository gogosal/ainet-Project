...
<div {{ $attributes->merge(['style' => "width:{$size};height:{$size};flex-shrink:0;display:flex;align-items:center;justify-content:center;"]) }}>
    <svg viewBox="0 0 200 220" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:100%;filter:drop-shadow(0 4px 8px rgba(0,0,0,0.25));">
        <defs>
        ...
        {{-- Collar detail --}}
        <path d="M 65,22 Q 76,42 100,42 Q 124,42 135,22"
              fill="none"
        ...
        @if($imageUrl)
            <image
                ...
                clip-path="url(#design-clip-{{ md5($imageUrl ?? 'none') }})"/>
        @endif
    </svg>
</div>
