                ...
                <table cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border:1px solid #e0ddd8;border-radius:10px;overflow:hidden;">
                    ...
                    <tr>
                        <td style="background:#eeecea;padding:0.75rem 2rem;text-align:center;border-bottom:1px solid #e0ddd8;">
                            <span style="display:inline-block;background:#c0392b;color:#ffffff;font-size:0.72rem;font-weight:600;padding:0.3rem 1rem;border-radius:20px;letter-spacing:0.06em;text-transform:uppercase;">Encomenda anulada</span>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:2rem;">
                            ...
                            <p style="margin:0 0 1.5rem;color:#555555;font-size:0.9rem;line-height:1.6;">
                                Lamentamos informar que a tua encomenda <strong style="color:#1a1a1a;">#{{ $order->id }}</strong> foi anulada.
                            </p>

                            @if($order->reason_for_cancellation)
                            <table width="100%" cellpadding="0" cellspacing="0" style="background:#fff5f5;border:1px solid #f5c6c6;border-radius:8px;margin-bottom:1.5rem;">
                                <tr>
                                    <td style="padding:1rem 1.25rem;">
                                        <p style="margin:0 0 0.25rem;font-size:0.72rem;font-weight:600;color:#c0392b;text-transform:uppercase;letter-spacing:0.06em;">Motivo</p>
                                        <p style="margin:0;font-size:0.9rem;color:#555555;line-height:1.5;">{{ $order->reason_for_cancellation }}</p>
                                    </td>
                                </tr>
                            </table>
                            @endif
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e0ddd8;border-radius:8px;overflow:hidden;margin-bottom:1.5rem;">
                                <tr>
                                    <td colspan="3" style="background:#eeecea;padding:0.75rem 1rem;border-bottom:1px solid #e0ddd8;">
                                        <p style="margin:0;font-size:0.72rem;font-weight:600;color:#888888;text-transform:uppercase;letter-spacing:0.06em;">Artigos anulados</p>
                                    </td>
                                </tr>
                                ...
                                <tr style="border-bottom:1px solid #e0ddd8;">
                                    ...
                                    <td style="padding:0.75rem 1rem 0.75rem 0;vertical-align:middle;text-align:right;">
                                        <p style="margin:0;font-size:0.9rem;font-weight:600;color:#888888;text-decoration:line-through;">€{{ number_format($item->sub_total, 2) }}</p>
                                    </td>
                                </tr>
                                @endforeach
                            </table>
                            ...
                            <p style="margin:0;color:#888888;font-size:0.82rem;line-height:1.6;">
                                Se tiveres alguma questão ou considerares que se trata de um erro, responde a este email.
                            </p>
                        </td>
                    </tr>
