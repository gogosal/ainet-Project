                ...
                <table cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;background:#ffffff;border:1px solid #e0ddd8;border-radius:10px;overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:2rem;">
                            <h2 style="margin:0 0 0.75rem;font-size:1.15rem;font-weight:600;color:#1a1a1a;">Recupera a tua password</h2>
                            ...
                            <p style="margin:1.5rem 0 0;color:#888888;font-size:0.8rem;line-height:1.6;">
                                Este link expira em <strong style="color:#555555;">60 minutos</strong>. Após expirar, terás de solicitar um novo link.<br><br>
