...
.logo { color: #1a1a1a; font-size: 1.4rem; font-weight: bold; }
.subtitle { color: #888888; font-size: 10px; margin-top: 0.25rem; letter-spacing: 0.08em; text-transform: uppercase; }
.meta-table { width: 100%; margin-bottom: 1.5rem; }
.meta-table td { vertical-align: top; padding: 0; color: #555555; line-height: 1.7; }
.meta-table .right { text-align: right; }
.meta-table strong { color: #1a1a1a; }
...
table.items thead tr { background: #eeecea; }
table.items th { padding: 0.55rem 0.5rem; text-align: left; font-size: 10px; text-transform: uppercase; letter-spacing: 0.08em; color: #888888; font-weight: 700; border-bottom: 1px solid #e0ddd8; }
table.items td { padding: 0.55rem 0.5rem; border-bottom: 1px solid #e0ddd8; color: #555555; vertical-align: middle; }
table.items .total-row td { font-weight: bold; color: #1a1a1a; font-size: 13px; border-top: 1.5px solid #e0ddd8; border-bottom: none; padding-top: 0.65rem; }
    ...
    <tbody>
        ...
        <tr>
            <td>
                ...
                @else
                <div style="width:44px;height:44px;background:#eeecea;border-radius:3px;border:1px solid #e0ddd8;"></div>
                @endif
            </td>
